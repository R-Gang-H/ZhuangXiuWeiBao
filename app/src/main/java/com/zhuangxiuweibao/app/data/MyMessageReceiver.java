package com.zhuangxiuweibao.app.data;
...
public class MyMessageReceiver extends MessageReceiver {
    ...
    public void onNotification(Context context, String title, String summary, Map<String, String> extraMap) {
        ...
        cPushMessage.setTitle(title);
        cPushMessage.setContent(summary);
        NotificationUtil.buildNotification(context, cPushMessage);
    }
    ...
    public void onMessage(Context context, CPushMessage cPushMessage) {
        Log.i(REC_TAG, "onMessage 收到一条推送消息 ： " + cPushMessage.getTitle() + ", content:" + cPushMessage.getContent());
        NotificationUtil.buildNotification(context, cPushMessage);
    }
