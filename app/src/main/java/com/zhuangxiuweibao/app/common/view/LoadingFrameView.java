...
//        emptyIcon = a.getResourceId(R.styleable.LoadingFrameView_fv_emptyIcon, R.drawable.icon_load);
        setNoIcon(a.getResourceId(R.styleable.LoadingFrameView_fv_noIcon, R.mipmap.ic_fv_no));
        setRepeatIcon(a.getResourceId(R.styleable.LoadingFrameView_fv_repeatIcon, R.mipmap.icon_wifi));
        a.recycle();
    ...
    public void setContainerShown(final boolean animate, int delay) {
        postDelayed(() ->
                setFrame(CONTAINER_ITEM, animate, false), delay);
    }
     ...
     * @return
     */
    public LVCircularRing getLoadInfoPb() {
        return loadInfoPb;
    }
